		...
		return Utilisateur.class.equals(cls);
		 ...
		 public void validateMdpInscription(Utilisateur u, Errors e, String mdpConf)
		 {
			//validation of password in inscription form
				...
				{
					e.rejectValue("mdp", "different.mdp", "les mots de passe sont différents");
				}
		 }
		 
		 public void validateConnexion(Object obj, Errors e) {
				ValidationUtils.rejectIfEmptyOrWhitespace(e, "pseudo", "pseudo.empty", "Le pseudo doit être saisi");
				ValidationUtils.rejectIfEmptyOrWhitespace(e, "mdp", "mdp.empty", "Le mdp doit être saisi");	
				}
...
//		 }
		...
		ValidationUtils.rejectIfEmptyOrWhitespace(e, "pseudo", "pseudo.empty", "Le pseudo doit être saisi");
		ValidationUtils.rejectIfEmptyOrWhitespace(e, "mdp", "mdp.empty", "Le mdp doit être saisi");
		ValidationUtils.rejectIfEmptyOrWhitespace(e, "dateNaissance", "dateNaissance.empty", "La dateNaissance doit être saisi");		
		}
